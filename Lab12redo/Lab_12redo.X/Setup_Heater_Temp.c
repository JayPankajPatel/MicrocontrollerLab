...
void Increase_Heater_Temp()
{
	...
	//check if it is greater than 110. If so, limit to 110
        setup_heater_set_temp++;
        if (setup_heater_set_temp > 110) setup_heater_set_temp = 110;
...
void Decrease_Heater_Temp()          
{
    ...
    // then check if it is less than 50. If so, limit to 50
        --setup_heater_set_temp;
        if (setup_heater_set_temp < 50) setup_heater_set_temp = 50;
