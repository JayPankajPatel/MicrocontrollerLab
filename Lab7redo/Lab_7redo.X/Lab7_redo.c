...
void init_IO()
{
    ...
    TRISB = 0x47;                                                                       // PORTB0-2 is input and PORTB6 is output, rest do not matter
...
void update_LCD_count(char direction, char count)                                               /*Note, the LCD only accepts ASCII values, using '0'or 0x30, 
                                                                                                offsets the decimal values by this value in order to convert
                                                                                                to ASCII    0x30 + D'5' = 0x35, which is 5 in ASCII*/
{
   switch (direction)                       
   {
      case NS:       
